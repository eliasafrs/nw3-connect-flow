  ...
  return (
    <section className="relative overflow-hidden bg-primary h-[calc(100svh-64px)] sm:min-h-[560px] lg:min-h-[620px] sm:h-auto">
      ...
      <div className="relative container mx-auto px-4 py-0 sm:py-20 lg:py-24 flex items-end sm:items-center h-full sm:min-h-[560px] lg:min-h-[620px]">
        <div className="max-w-2xl mx-0 sm:mx-[50px] pb-12 sm:pb-0">
          {/* Tag */}
          ...
          {/* Main heading */}
          <h1 className="font-heading text-2xl sm:text-5xl lg:text-6xl font-black text-white leading-[1.1] mb-2 sm:mb-3 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
            {slide.tagline}
          </h1>
          <p className="text-sm sm:text-xl mb-4 sm:mb-6 max-w-lg text-yellow-400 drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)] [text-shadow:0_1px_4px_rgba(0,0,0,0.9)]">
            {slide.subtitle}
          </p>
          ...
          <div className="flex flex-wrap items-end gap-4 sm:gap-6 mb-4 sm:mb-8">
            {slide.speed && (
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="flex flex-col items-center">
                  <span className="font-heading text-4xl sm:text-5xl lg:text-7xl font-black text-white leading-none">
                    {slide.speed}
                  </span>
                  <span className="font-heading text-base sm:text-xl font-bold text-white/80 uppercase">
                    {slide.label}
                  </span>
                </div>
                {slide.logo && (
                  <div className="flex items-center gap-2">
                    ...
                    <img src={slide.logo} alt="Logo parceiro" className={`object-contain ${slide.logo === disneyPlusLogo ? 'h-8 sm:h-11' : 'h-10 sm:h-14'}`} />
                  </div>
                )}
              </div>
            )}
            ...
            <div className="border-l-2 border-white/20 pl-4 sm:pl-6">
              <div className="flex items-baseline gap-0.5">
                <span className="text-white/60 text-xs sm:text-sm">R$</span>
                <span className="font-heading text-4xl sm:text-5xl font-black text-yellow-400 leading-none">
                  {slide.price}
                </span>
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            <Button variant="cta" size="lg" className="text-sm sm:text-base px-5 sm:px-8 h-10 sm:h-11">
              {slide.cta}
            ...
            >
              <Button variant="outline" size="lg" className="text-sm sm:text-base bg-yellow-400 hover:bg-yellow-500 border-yellow-400 text-black font-bold px-5 sm:px-8 h-10 sm:h-11">
