...
const Footer = () => {
  return (
    <footer className="bg-footer py-16 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              {[
                { Icon: Facebook, href: "https://www.facebook.com/Nw3InternetSP" },
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { label: "Área do Cliente", href: "https://nw3.sgp.tsmx.com.br/accounts/central/login" },
                { label: "2ª Via de Boleto", href: "https://nw3.sgp.tsmx.com.br/accounts/central/login" },
        ...
        <div className="border-t border-primary-foreground/10 pt-6 pb-24 sm:pb-0 flex flex-col sm:flex-row items-center justify-between gap-4 sm:pr-24">
          <p className="text-xs text-primary-foreground/40 text-center sm:text-left">
            © 2026 NW3 Internet. Todos os direitos reservados. CNPJ: 33.578.123/0001-63
          </p>
